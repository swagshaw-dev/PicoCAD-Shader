Shader "Custom/v30" 
{
    Properties
    {
        ...
        _DitherNearScale("Plaid Scale (Near)", Float) = 0.01
        _DitherFarScale("Plaid Scale (Far)", Float) = 0.05
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 fragBackFaces(Varyings IN, half facing : VFACE) : SV_Target
            {
                ...
                float dynamicDitherScale = lerp(_DitherNearScale, _DitherFarScale, distFactor);
                
                float2 screenCell = floor(IN.positionCS.xy / max(0.0001, dynamicDitherScale * min(_ScreenParams.x, _ScreenParams.y)));
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN, half facing : VFACE) : SV_Target
            {
                ...
                float  scale     = max(0.0001, dynamicDitherScale * shortSide);
