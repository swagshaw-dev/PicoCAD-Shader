    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 fragBackFaces(Varyings IN, half facing : VFACE) : SV_Target {
                ...
                // Full Lighting Path for Backfaces
                ...
                int paletteRow = (shaped < _ThreshBlack) ? 3 : (shaped < _ThreshDark) ? (plaid < 0.5 ? 3 : 2) : 0;
                return half4(SamplePalette(colorIdx, paletteRow), 1.0);
            }
            ENDHLSL
        }
