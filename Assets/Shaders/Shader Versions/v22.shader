    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN, half facing : VFACE) : SV_Target
            {
                ...
                // LOD 0 forces the full-resolution mip level, bypassing hardware
                // mip filtering. Without this, at distance the sampler blends the
                // index texture color toward adjacent pixels (e.g. white borders),
                // causing the nearest-palette loop to occasionally snap to the wrong
                // color and produce stray speckles on the surface.
                float4 inputSample = SAMPLE_TEXTURE2D_LOD(_IndexTex, sampler_IndexTex, IN.uv, 0);
