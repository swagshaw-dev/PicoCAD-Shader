    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN, half facing : VFACE) : SV_Target
            {
                ...
                //
                // _ThreshBand is a user-tunable minimum that applies everywhere;
                // the gradient raises it automatically only at actual edges and lighting
                // transitions, leaving flat face interiors unaffected.
                //
