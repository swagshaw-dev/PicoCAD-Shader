Shader "Custom/v60"
{
    Properties
    {
        ...
        _UniformObjectScale ("Uniform Grid Scale (Object Units)", Float) = 1.0
    ...
    SubShader
    {
        ...
        // ----------------------------------------------------------------------
        // Plaid pattern: screen-space, dynamic, or hard-axis object-space grid.
        // ----------------------------------------------------------------------
        float CalculatePlaid(float4 positionCS, float3 positionWS, float2 uv, float3 positionOS, float3 normalOS)
        {
            // Uniform Object Dither: Hard-Axis Projection
            // Picks the dominant surface axis and projects a discrete checkerboard
            // onto the orthogonal plane. No blending = strictly 0 or 1 output.
