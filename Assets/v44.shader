    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 fragBackFaces(Varyings IN, half facing : VFACE) : SV_Target {
                ...
                if (_BackFaceMode < 1.5) {
                    return half4(SamplePalette(colorIdx, (_BackFaceMode < 0.5) ? 0 : 3), 1.0);
                }
                ...
                for (uint i = 0; i < pixelLightCount; ++i) {
                    ...
                    lightFactor += saturate(dot(normalWS, addLight.direction) * lightSign) * addLight.distanceAttenuation * step(_ShadowCutoff, addLight.shadowAttenuation);
                }
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN, half facing : VFACE) : SV_Target {
                ...
                int paletteRow = GetShadedRow(saturate(lightFactor), plaid);
